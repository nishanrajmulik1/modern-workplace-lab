...
**Goal:** Establish the Microsoft 365 tenant, licensing, identities, and the Entra groups every later project targets.
...
**Résumé line:** *Stood up a Microsoft 365 E3 tenant with Entra ID P1, a verified custom domain, and dynamic device groups as the foundation for hybrid identity and endpoint management.*
